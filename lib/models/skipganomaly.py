...
class Skipganomaly(BaseModel):
    ...
    def test(self, plot_hist=False):
        ...
        with torch.no_grad():
            ...
            auc,recall =  roc(self.gt_labels, self.an_scores)
            ...
            if plot_hist:
                ...
                #hist.to_csv("/media/ccg1/backup/Rushikesh_Krupa/code/attention_spectralnorm/histogram.csv")
                ...
                plt.close()
                #plt.savefig("/media/ccg1/backup/Rushikesh_Krupa/code/attention_spectralnorm/plot.jpg")
