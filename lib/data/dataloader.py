...
def load_data(opt):
    ...
    ##
    # LOAD DATA SET
    opt.dataroot == '/media/ccg1/backup/Rushikesh_Krupa/dataset/30k_patched'
    ...
    # FOLDER
        ...
        train_ds = ImageFolder('/home/ccg3/Desktop/Krupa_Rushikesh/mvtec_anomaly_detection/hazelnut/train', transform)
        valid_ds = ImageFolder('/home/ccg3/Desktop/Krupa_Rushikesh/mvtec_anomaly_detection/hazelnut/test', transform)
